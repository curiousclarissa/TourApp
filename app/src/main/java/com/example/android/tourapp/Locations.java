...
public final class Locations {
    public static final Location[] LOCATIONS = {
            new Location((getResources().getString(R.string.location_u_heights), "206-527-4278", "www.uheightscenter.org", "address", R.drawable.ic_place_black_24dp, new ArrayList<Integer>(Arrays.asList(Location.LOCATION_CATEGORY_POI, Location.LOCATION_CATEGORY_PARKSANDREC))),
